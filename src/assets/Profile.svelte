<script>
	const accentColor = getComputedStyle(document.body).getPropertyValue("--a");
	let hover = false;
	$: fillColor = hover ? accentColor : "none";
</script>
...
>
	...
	>
		...
		<circle
			...
			r="19.817"
			style="stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: hsl(var(--bc)); fill-rule: nonzero; opacity: 1;"
			transform="  matrix(1 0 0 1 0 0) "
		/>
		<path
		...
		<path
			...
			style={`stroke: none; stroke-width: 1; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: hsl(${fillColor}); fill-rule: nonzero; opacity: 1;`}
			transform=" matrix(1 0 0 1 0 0) "
			stroke-linecap="round"
		/>
		<path
